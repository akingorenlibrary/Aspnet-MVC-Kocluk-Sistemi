...
{
    public class AdminAddAntrenorDto
    {
        ...
        [Required(ErrorMessage = "Uzmanlık Alanları numarası alanı boş bırakılamaz")]
        public string UzmanlikAlanlari { get; set; }
        public string SifreSifirlamaMetni { get; set; }

        [Required(ErrorMessage = "Deneyimleri alanı boş bırakılamaz")]
